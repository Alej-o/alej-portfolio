export const displayShader =  `precision mediump float;
...
// FBM & bruit (copiés depuis ton shader original)
float random(vec2 p) {
...
void main() {
  ...
  // Ajout de la distorsion fluide
  vec4 fluid = texture2D(iFluid, vUv);
  vec2 distortion = fluid.xy * uDistortionAmount;
  st += distortion;
  ...
  // --- dégradé de couleur basé sur ton style
